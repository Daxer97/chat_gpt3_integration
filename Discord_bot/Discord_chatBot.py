...
openai.api_key = "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"
    ...
    for message in messages:
        ...
        if message.startswith("```") and message.endswith("```"):
            ...
            if len(message) > 1990:
                ...
                print("code block not longer than 2000 charcaters")
...
client.run("MTA1NTU0NzUxNTA3NzkyNjk5Mg.G2aufb.-41aziAPDAeJxodaPkgYRi89-bWbVsBH6doo-w")